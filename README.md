...
<body>
    ...
    <div class="viewport">
                ...
                <div class="card" style="border: 1px solid var(--c-emerald);">
                    ...
                    <div style="display:flex; gap:10px;">
                        <div class="card" style="flex:1; margin:0; padding:10px; text-align:center; background:#f8fafc;" id="slot-gloves">
                            <div style="font-size:24px;">🧤</div><div style="font-size:10px; font-weight:700;">Gloves</div>
                        </div>
                        <div class="card" style="flex:1; margin:0; padding:10px; text-align:center; background:#f8fafc;" id="slot-bag">
                            <div style="font-size:24px;">🎒</div><div style="font-size:10px; font-weight:700;">Bag</div>
                        </div>
                    </div>
        ...
        <div id="view-map" class="view">
            ...
            <div class="map-ctrl">
                ...
                <div class="chip" onclick="MapSys.filter('checkpoint', this)">🎒 Checkpoints</div>
                <div class="chip" onclick="MapSys.filter('mosque', this)">🕌 Surau</div>
            </div>
        </div>
        ...
        <div id="view-profile" class="view">
            <div class="scroll-y">
                ...
                <div class="card">
                    ...
                    <div style="display:flex; gap:10px;">
                        <div style="width:50px; height:50px; background:#f1f5f9; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:20px;">🌊</div>
                        <div style="width:50px; height:50px; background:#f1f5f9; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:20px;">🕌</div>
                        <div style="width:50px; height:50px; background:#f1f5f9; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:20px;">🎒</div>
                    </div>
                </div>
        ...
        <div id="modal-wudhu" class="modal">
            <div class="modal-box" style="text-align:left;">
                ...
                <div style="text-align:center; margin-top:15px; font-size:24px; cursor:pointer;" onclick="WudhuSys.close()">✕</div>
            </div>
        </div>
    ...
    <script>
        ...
        const MapSys = {
            ...
            render(filter) {
                this.data.forEach(item => {
                    ...
                    const icon = item.type === 'checkpoint' ? '🎒' : '🕌';
        ...
        const Scanner = {
            ...
            capture() {
                if(!App.hasGear) { alert("⚠️ Collect Eco-Kit first!"); return; }
        ...
        const WudhuSys = {
            ...
            result(val) {
                this.close();
                alert(val ? "✅ Mutlaq (Pure). Valid." : "❌ Changed. Invalid.");
            }
        };
    </script>
</body>
